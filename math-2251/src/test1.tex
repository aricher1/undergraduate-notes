...
\begin{formulabox}
    ...
    \begin{enumerate}
        ...
        \item For each distinct eigenvalue \(\lambda_i\) determine a basis \(\mathcal{B}_i = \{\vec{v}_{i1}, \dots , \vec{v}_{il_i} \}\) od the \(\lambda_i\) eigenspace \(\mathcal{N}(\lambda_i I_n - A)\) of \(A\).
        \item Set 
        \[
